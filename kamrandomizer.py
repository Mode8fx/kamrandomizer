...
#    Jul 07, 2020 05:56:41 PM EDT  platform: Windows NT
...
- No''')
        ...
        self.Label_AbilityDistribution = ttk.Label(self.TFrame1)
        self.Label_AbilityDistribution.place(x=20, y=25,  height=19, width=105)
...
- By Ability Frequency (abilities will be tied to the same number of enemy types as in the original game; for example, two enemies gave Ice in the original game, so two random enemies will give Ice here)''')
        ...
        self.Label_EnemiesWithoutAbility = ttk.Label(self.TFrame1)
        self.Label_EnemiesWithoutAbility.place(x=200, y=25, height=19, width=155)
...
- No Random (Unchanged) (basic enemies will still not give an ability; other enemies will)''')
        ...
        self.Label_UndecidedEnemyChance = ttk.Label(self.TFrame1)
        self.Label_UndecidedEnemyChance.place(x=360, y=12, height=32, width=146)
...
0% - Never''')
        ...
        self.Label_UndecidedObjectChance = ttk.Label(self.TFrame1)
        self.Label_UndecidedObjectChance.place(x=200, y=135, height=32
                , width=146)
